import 'package:ecommerce_app1/presentation/Cart/cart_items.dart';
import 'package:ecommerce_app1/presentation/widgets/dark_light_button.dart';
import 'package:ecommerce_app1/providers/cart_items.dart';
import 'package:ecommerce_app1/providers/products_data.dart';

import 'package:ecommerce_app1/utils/routs.dart';
...
class IconBtnWithCounter extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final cartProductItems = ref.watch(cartNotifierProvider);
    return InkWell(
