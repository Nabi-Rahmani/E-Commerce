  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          const CircleAvatar(
            foregroundImage: AssetImage('assets/images/nabi.jpg'),
            //!
          ),
          Positioned(
            right: -16,
    ...
    return Padding(
      ...
      child: TextButton(
        style: TextButton.styleFrom(
          ...
          backgroundColor:
              isDarkMode.isDarkMode ? Colors.green : const Color(0xFFFFC107),
        ),
        onPressed: press,
        child: Row(
          children: [
            ...
            Expanded(
              child: Text(
                ...
                style: TextStyle(
                  ...
                  color: isDarkMode.isDarkMode ? Colors.white : Colors.white,
                ),
              ),
            ),
            const Icon(
